      ...
      <AuthProvider>
        <Routes>
          ...
          <Route path="/*" element={<SidebarLayout />}>
            ...
            <Route path="tornei/nuovo/step5-5-fasegironi" element={<Step5_5_FaseGironi />} />
            ...
            <Route path="tornei/nuovo/step6-eliminazione/:torneoId/edit/:matchId" element={<ModificaRisultatoEliminazione />} />
            <Route path="tornei/nuovo/step6-fasegironi/:torneoId/edit/:matchId" element={<EditFaseGironiPartita />} />
